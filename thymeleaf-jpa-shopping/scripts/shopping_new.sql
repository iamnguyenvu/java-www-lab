-- ========================================
-- Shopping Database Schema - MariaDB
-- ========================================
...
CREATE TABLE comment (
    ...
    CONSTRAINT fk_comment_customer FOREIGN KEY (customer_id) REFERENCES customer(customer_id) ON DELETE CASCADE,
...
-- Order 2: Jane Smith (DELIVERED) - Phone + Gaming Mouse
(1, 999.99, 999.99, 3, 2),
(1, 79.99, 79.99, 6, 2),
...
-- Order 7: Jane Smith (CONFIRMED) - iPad + Electric Toothbrush
(1, 599.99, 599.99, 5, 7),
(1, 49.99, 49.99, 32, 7),

-- Order 8: Alice Brown (CONFIRMED) - Yoga Mat + Running Shoes
(3, 29.99, 89.97, 25, 8),
(2, 119.99, 239.98, 24, 8),

-- Order 9: Bob Wilson (PENDING) - Running Shoes
(3, 119.99, 359.97, 24, 9),
